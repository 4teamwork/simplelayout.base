...
VIEW_INTERFACES_MAP = {'normal': ISimplelayoutView,
                       'two-columns': ISimplelayoutTwoColumnView,
                       'two-columns-one-on-top':
                            ISimplelayoutTwoColumnOneOnTopView}

SLOT_INTERFACES_MAP = {'slotA': ISlotA,
                       'slotB': ISlotB,
                       'slotC': ISlotC,
                       'slotD': ISlotD}

COLUMN_INTERFACES_MAP = {'onecolumn': IOneColumn,
                         'twocolumn': ITwoColumn,
                         'threecolumn': IThreeColumn}

INIT_INTERFACES_MAP = {'normal': [ISlotA, IOneColumn],
                       'two-columns': [ISlotA, ITwoColumn],
                       'two-columns-one-on-top': [ISlotA, IOneColumn]}

IMAGE_SIZE_MAP_PER_INTERFACE = {IOneColumn: dict(small_size='small_size',
...
CONFIGLET_INTERFACE_MAP = {'sl-config': ISimplelayoutConfiguration}
